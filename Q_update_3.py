...
from PyQt6.QtWidgets import (
    ...
    QButtonGroup, QTextEdit, QPlainTextEdit,QMessageBox,QSizePolicy
...
class ExamPage(QWidget):
    ...
    def setup_ui(self):
        ...
        left_layout.addWidget(options_container)
        
        # Description answer container
        ...
        self.description_editor.setMinimumHeight(400)  # Increased height
        ...
        self.code_editor.setMinimumHeight(400)  # Increased height
        ...
        coding_layout.addWidget(self.code_editor, 3)  # Give code editor more vertical space
        
        # Add output area
        output_layout = QVBoxLayout()
        output_header = QLabel("Output:")
        output_header: QLabel = QLabel("Output:")
        ...
        self.code_output.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        ...
        coding_layout.addLayout(output_layout, 1)  # Give output area less vertical space
        ...
        left_layout.addWidget(stretch_widget)
    ...
    def load_question(self, index):
        ...
        if question_type == "1":  # Descriptive
            ...
            # Ensure description editor takes maximum space
            self.description_editor.setMinimumHeight(400)
            ...
            # Ensure code editor takes maximum space
        ...
        # Ensure editors maintain their proportions in the layout
        if question_type == "1":  # Descriptive
    ...
    def store_user_answer(self):
        ...
        # In the store_user_answer method, find the section handling question_type == "4" (Coding)
        elif question_type == "4":  # Coding
