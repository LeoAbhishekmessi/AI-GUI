...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QRadioButton, QButtonGroup, QGridLayout,QMessageBox,QScrollArea
)
...
from PyQt6.QtWidgets import (
    ...
    QPushButton, QLineEdit, QRadioButton, QButtonGroup, QGroupBox, QGridLayout,QFrame
)
...
class ExamPage(QWidget):
    ...
    def load_question(self, index):
        ...
        for i, option in enumerate(options):
            ...
            # For debugging
            print(f"Added option {i}: {letter}. {option_text}")
    ...
    def submit_exam(self):
        ...
        if msg_box.exec() == QMessageBox.StandardButton.Yes:
            ...
            try:
                ...
                # submit_exam_answers(self.exam_id, self.user_id, self.user_answers)
